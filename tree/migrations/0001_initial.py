# Generated by Django 2.2.13 on 2021-02-23 03:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('marriage_date', models.DateField(help_text='Marriage date.', null=True)),
                ('divorce_date', models.DateField(help_text='Divorce date.', null=True)),
                ('person', models.ManyToManyField(related_name='partners', to='tree.Person')),
            ],
        ),
    ]
